...
pub fn all() -> &'static [&'static PreviewRegistration] {
    use crate::products::history::docs::{
        ...
        HISTORYEMBEDDOC_PREVIEW_REGISTRATION, HISTORYLOADINGDOC_PREVIEW_REGISTRATION,
        HISTORYLOCALIZATIONDOC_PREVIEW_REGISTRATION, HISTORYMULTIDIFFDOC_PREVIEW_REGISTRATION,
        HISTORYORIENTATIONDOC_PREVIEW_REGISTRATION, HISTORYRENDERERSDOC_PREVIEW_REGISTRATION,
