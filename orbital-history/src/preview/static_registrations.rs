...
pub fn all() -> &'static [&'static PreviewRegistration] {
    use crate::products::history::docs::{
        ...
        HISTORYEMBEDDOC_PREVIEW_REGISTRATION, HISTORYHANDLEDOC_PREVIEW_REGISTRATION,
        ...
        HISTORYORIENTATIONDOC_PREVIEW_REGISTRATION, HISTORYREFRESHDOC_PREVIEW_REGISTRATION,
