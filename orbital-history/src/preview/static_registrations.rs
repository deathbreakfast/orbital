...
pub fn all() -> &'static [&'static PreviewRegistration] {
    use crate::products::history::docs::{
        ...
        HISTORYMULTIDIFFDOC_PREVIEW_REGISTRATION, HISTORYLAYOUTDOC_PREVIEW_REGISTRATION,
        ...
        HISTORYSERVERFILTERDOC_PREVIEW_REGISTRATION, HISTORYSLOTSDOC_PREVIEW_REGISTRATION,
        HISTORYSORTDOC_PREVIEW_REGISTRATION, HISTORYTIMEZONEBUCKETSDOC_PREVIEW_REGISTRATION,
